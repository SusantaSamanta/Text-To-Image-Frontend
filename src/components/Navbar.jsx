                ...
                <div className='border-0 w-auto flex flex-col justify-center items-center font-semibold '>
                    {
                        isLogin ?
                            ...
                            <div className='border-0 w-auto flex items-center md:gap-2 lg:gap-4 text-gray-700'>
                                <Link to='/generate' className=' border-b-2 border-transparent hover:border-black transition duration-200'>Generate</Link>
                                <Link to='/bye' className='px-3 lg:px-6 py-2 bg-blue-400 hover:bg-blue-500 shadow-[2px_2px_6px_#4a4a4a72] text-white rounded-2xl'>
